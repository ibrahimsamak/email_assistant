...
4. manage_memory_tool - Store any relevant information about contacts, actions, discussion, etc. in memory for future reference
5. search_memory_tool - Search for any relevant information that may have been stored in memory
</ Tools >
